...
import {
  ...
  preCollectOrderFindPageForManage,
} from "@/api/vehicle-monitoring/order.js";

import { preCollectOrderExport } from "@/api/vehicle-monitoring/order";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      preCollectOrderFindPageForManage(this.params).then((response) => {
