        ...
        <el-card class="box-card mb10">
          <div slot="header" class="clearfix">
            ...
            <span style="float: right"
              >客户编号：{{ detailForm.customer.customerNo }}</span
            >
          </div>
          <el-descriptions title="" :column="2">
            <el-descriptions-item label="客户姓名">{{
              detailForm.customer.name || ""
            }}</el-descriptions-item>
            <el-descriptions-item label="客户电话">{{
              detailForm.customerPhoneNumber
            }}</el-descriptions-item>
    ...
    <el-row :gutter="10" class="mb10">
      ...
      <!-- <el-col :span="12">
        <el-card class="box-card">
          ...
          <OrderStep :orderInfo="detailForm" vertical/>
        </el-card>
      </el-col> -->
    </el-row>
    <el-row :gutter="10">
...
<script>
import { getPreCollectOrderFindById } from "@/api/vehicle-monitoring/order";
export default {
  data() {
    return {
      mode: "view",
  ...
  methods: {
    getDetail() {
      getPreCollectOrderFindById({ id: this.$route.query.orderId }).then(
        (res) => {
