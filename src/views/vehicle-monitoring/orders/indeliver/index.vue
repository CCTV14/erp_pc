    ...
    >
      ...
      <el-form-item class="flex-end">
        <el-button
          ...
          icon="el-icon-search"
          size="mini"
          v-hasPermi="['vehicle:indeliver:query']"
          @click="handleQuery"
          >搜索</el-button
        >
      ...
      >
        <template slot-scope="scope">
          <el-button
            ...
            v-hasPermi="['vehicle:indeliver:confirm']"
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      getInDeliverList(this.params).then((response) => {
    ...
    canConfirmDelivery(head) {
      return (
        ...
        head.needDelivery &&
        this.$thinking.checkAuth("vehicle:commodityinputorder:confirmdelivery")
      );
    },
  },
};
