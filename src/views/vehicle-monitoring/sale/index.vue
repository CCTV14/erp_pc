<template>
    <div class="app-container">
        <el-form :model="params" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
            ...
            <el-form-item label="出库进度" prop="ident">
                <el-select v-model="params.ident" multiple style="width:160px;" placeholder="请选择出库进度" clearable>
                    <el-option label="全部出库" value="2"></el-option>
                </el-select>
            </el-form-item>
            <el-form-item label="收款进度" prop="ident">
                <el-select v-model="params.ident" multiple style="width:160px;" placeholder="请选择收款进度" clearable>
