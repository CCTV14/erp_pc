      ...
      >
        <template slot-scope="scope">
          <el-button
            ...
            v-hasPermi="['vehicle:outdelivermy:startdelivery']"
...
import { getMyOutDeliverList } from "@/api/vehicle-monitoring/order-my.js";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      getMyOutDeliverList(this.params).then((response) => {
    ...
    isSaleOrderOutput(head) {
      return head.commodityOutputOrderTypeEnum.Name === "SaleOrder";
    },
    currentUserDelivery(head) {
      return (
    ...
    canStartDelivery(head) {
      return (
        ...
        this.isSaleOrderOutput(head) &&
        head.needDelivery &&
        this.currentUserDelivery(head)
      );
    },
    // 判断完成配送
