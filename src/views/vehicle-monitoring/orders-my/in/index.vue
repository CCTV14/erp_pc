    ...
    >
      ...
      <el-form-item class="flex-end">
        <el-button
          ...
          icon="el-icon-search"
          size="mini"
          v-hasPermi="['vehicle:inordermy:query']"
          @click="handleQuery"
          >搜索</el-button
        >
      ...
      >
        <template slot-scope="scope">
          <el-button
            ...
            v-hasPermi="['vehicle:inordermy:submit']"
          ...
          <el-button
            ...
            type="text"
            icon="el-icon-delete"
            v-hasPermi="['vehicle:inordermy:delete']"
            v-if="
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      myInOrderFindPageForManage(this.params).then((response) => {
    ...
    /** 提交 */
    handleSubmitById(id) {
      myInOrderSubmitById(id).then((res) => {
        // 可能要做弹框显示操作...
        if (res.success) {
