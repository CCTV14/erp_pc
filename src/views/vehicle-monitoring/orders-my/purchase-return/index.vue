<template>
  <div class="app-container">
    ...
    >
      ...
      <el-form-item class="flex-end">
        <el-button
          ...
          icon="el-icon-search"
          size="mini"
          v-hasPermi="['vehicle:purchasereturnordermy:query']"
          @click="handleQuery"
          >搜索</el-button
        >
    ...
    >
      ...
      <el-table-column label="单号" align="center" prop="orderNo" width="150">
      ...
      <el-table-column label="制单信息" align="center" min-width="200">
        <template slot-scope="scope">
      ...
      >
        <template slot-scope="scope">
          <el-button
            ...
            v-hasPermi="['vehicle:purchasereturnordermy:submit']"
          ...
          <el-button
            ...
            v-hasPermi="['vehicle:purchaseordermy:delete']"
            v-if="
          ...
          <el-dropdown
            ...
            v-hasPermi="[
              'vehicle:purchasereturnordermy:in',
              'vehicle:purchasereturnordermy:pay',
            ]"
          >
            ...
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item
                ...
                v-hasPermi="['vehicle:purchasereturnordermy:in']"
                >发起入库</el-dropdown-item
              >
              <el-dropdown-item
                command="handleSubmitPay"
                icon="el-icon-finished"
                v-hasPermi="['vehicle:purchasereturnordermy:pay']"
...
import {
  myPurchaseReturnOrderFindPageForManage,
  myPurchaseReturnOrderSubmitById,
...
export default {
    ...
    return {
      ...
      params: {
        quickSearchInfoList: [
          ...
          {
            columns: ["relatedPurchaseOrderHead.orderNo"],
            quickSearchValue: null,
          },
          {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      myPurchaseReturnOrderFindPageForManage(this.params).then((response) => {
    ...
    /** 提交 */
    handleSubmitById(id) {
      myPurchaseReturnOrderSubmitById(id).then((res) => {
        // 可能要做弹框显示操作...
        if (res.success) {
    ...
    handleDelete(row) {
      ...
      this.$modal
        ...
        .then(function () {
          return deletePurchaseReturnOrder(id);
        })
        .then((res) => {
          if (res.success) {
            this.getList();
