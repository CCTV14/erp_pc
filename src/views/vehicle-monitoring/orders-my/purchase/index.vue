    ...
    >
      ...
      <el-form-item class="flex-end">
        <el-button
          ...
          icon="el-icon-search"
          size="mini"
          v-hasPermi="['vehicle:purchaseordermy:query']"
          @click="handleQuery"
          >搜索</el-button
        >
      ...
      >
        <template slot-scope="scope">
          <el-button
            ...
            v-hasPermi="['vehicle:purchaseordermy:submit']"
          ...
          <el-dropdown
            ...
            v-hasPermi="[
              'vehicle:purchaseordermy:in',
              'vehicle:purchaseordermy:pay',
              'vehicle:purchaseordermy:return',
            ]"
          >
            ...
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item
                ...
                v-hasPermi="['vehicle:purchaseordermy:in']"
                >发起入库</el-dropdown-item
              >
              <el-dropdown-item
                command="handleSubmitPay"
                icon="el-icon-finished"
                v-hasPermi="['vehicle:purchaseordermy:pay']"
                >发起付款</el-dropdown-item
              >
              <el-dropdown-item
                command="handleSubmitReturn"
                icon="el-icon-finished"
                v-hasPermi="['vehicle:purchaseordermy:return']"
...
import {
  myPurchaseOrderFindPageForManage,
  myPurchaseOrderSubmitById,
  deletePurchaseOrder,
...
export default {
  ...
  data() {
    return {
      ...
      params: {
        ...
        quickSearchInfoList: [
          {
            columns: ["orderNo", "supplier.name", "creator.name"],
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      myPurchaseOrderFindPageForManage(this.params).then((response) => {
    ...
    /** 提交 */
    handleSubmitById(id) {
      myPurchaseOrderSubmitById(id).then((res) => {
        // 可能要做弹框显示操作...
        if (res.success) {
